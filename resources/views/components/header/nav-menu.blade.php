...
<nav class="hidden items-center gap-2 lg:flex" aria-label="Navegação principal">
    ...
    <button
        ...
        class="group flex min-h-11 min-w-11 items-center justify-center rounded-tl-2xl rounded-br-2xl text-pink-600 transition-all duration-300 hover:scale-110 focus:outline-none focus-visible:ring-2 focus-visible:ring-pink-600 focus-visible:ring-offset-2"
    >
